...
3. `yay -S hyprland hypridle hyprlock hyprpaper hyprshot hyprpolkitagent hyprgraphics hyprpicker jellyfin-media-player downgrade slack-desktop cloud-sql-proxy flux-bin lazygit lazydocker selectdefaultapplication-fork-git brave-bin neovim-git localsend-bin pandoc-bin vesktop-git proton-authenticator-bin proton-vpn-gtk-app tofi xorg-xhost obs-studio onlyoffice-bin qt6ct-kde && sudo pacman -Rns firefox kitty`
