...
3. `yay -S hyprland-git hypridle-git hyprlock-git hyprpaper-git hyprshot-git hyprpolkitagent-git hyprgraphics-git jellyfin-media-player lazygit lazydocker selectdefaultapplication-fork-git brave-bin neovim-git localsend-bin pandoc-bin vesktop-git proton-authenticator-bin proton-vpn-gtk-app tofi && sudo pacman -Rns firefox kitty`
