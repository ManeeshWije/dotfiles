...
3. `yay -S hyprland-git hypridle-git hyprlock-git hyprpaper-git hyprsunset-git hyprshot-git hyprpolkitagent-git hyprgraphics-git lazygit lazydocker selectdefaultapplication-fork-git brave-bin neovim-git localsend-bin pandoc-bin vesktop-git proton-authenticator-bin proton-vpn-gtk-app tofi && sudo pacman -Rns firefox kitty`
4. `sudo pacman -S less imv mpv nwg-look ueberzugpp ncspot pavucontrol syncthing power-profiles-daemon blueman cliphist starship gvfs glib2 gvfs-mtp gvfs-afc gvfs-google gvfs-gphoto2 gvfs-nfs gvfs-smb gvfs-afc gvfs-dnssd gvfs-goa gvfs-onedrive gvfs-wsdd brightnessctl`
