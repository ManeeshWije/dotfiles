...
# install everything
brew install lua-language-server via postman min ninja rust-analyzer ripgrep fzf ccls clang-format cmake cmatrix git go heroku htop llvm lua mongosh ncdu neofetch neovim node nvm pfetch python speedtest-cli starship tmux tty-clock audacity balenaetcher firefox caffeine discord microsoft-teams minecraft slack spotify visual-studio-code zoom alacritty
...
# clone projects
# mkdir ~/dev/Projects && cd dev/Projects
