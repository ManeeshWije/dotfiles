...
# install everything
brew install bpytop ccls clang-format cmake cmatrix fish git go heroku htop llvm lua mongosh ncdu neofetch neovim node nvm pfetch python speedtest-cli starship tmux tty-clock audacity balenaetcher brave-browser caffeine discord firefox iterm2 kap microsoft-teams minecraft mysqlworkbench obs slack spotify visual-studio-code zoom 
# vim plug
