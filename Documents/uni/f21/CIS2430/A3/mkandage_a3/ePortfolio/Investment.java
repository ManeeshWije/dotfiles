...
public abstract class Investment {
    ...
    // copy constructor
    Investment(Investment temp) {
        this.type = temp.type;
        this.symbol = temp.symbol;
        this.name = temp.name;
        this.quantity = temp.quantity;
        this.price = temp.price;
        this.bookValue = temp.bookValue;
    }
    ...
    /**
     *
     * Overriding equals method with Object other
     *
     * @param other holds the other object
     */
    @Override
    public boolean equals(Object other) {
        ...
        // Check if other is an instance of Investment or not
        if (getClass() != other.getClass()) {
            return false;
        }
        // typecast o to Investment so that we can compare data members
        Investment other1 = (Investment) other;
        // Compare the data members and return accordingly
        return (type.equals(other1.type) && symbol.equals(other1.symbol) && name.equals(other1.name)
                && quantity == other1.quantity && price == other1.price && bookValue == other1.bookValue);
    }
     ...
     * @param price    the price
     */
    public abstract void setBookValue(int quantity, double price);
     ...
     * @return the gain
     */
    public abstract double getGains();
