...
public class Student {
    ...
    // String[] split = scan.nextLine().split("\\s+"); // this regex line allows us
    // to have as many spaces between
    // // splits
    ...
    // if (stringAvg.equals("") || stringAvg.equals(" ")) { // checking if empty
    // input and if so, set avg to 0.00
    // // specified
    // this.avg = 0.00;
    // } else { // converting inputted string into a double in order to add to
    // average arraylist
